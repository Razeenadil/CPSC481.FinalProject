    ...
    public partial class DemoVideoPage : Page, INotifyPropertyChanged
    {
        ...
        private void PopulateListBox(bool arms, bool legs, bool back, bool chest, bool abs)
        {
            ...
            if(legs)
            {
                ...
                {
                    BodyPart = "Legs",
                    TargetBodyPart = "Glutes and Quadriceps",
                    Name = "Barbell Squats",
                ...
                {
                    BodyPart = "Legs",
                    TargetBodyPart = "Quadriceps, Hamstrings, Glutes and Calves",
                    Name = "Lunges",
            ...
            if(chest)
            {
                ...
                {
                    BodyPart = "Chest",
                    TargetBodyPart = "Pectorals, Arms, and Shoulders",
                    Name = "Bench Press",
                ...
                {
                    BodyPart = "Chest",
                    TargetBodyPart = "Pectorals and Triceps",
                    Name = "Dips",
            ...
            if(abs)
            {
                ...
                {
                    BodyPart = "Abs",
                    TargetBodyPart = "Oblique, Pelvis, Lower Back, and Hips",
                    Name = "Crunches",
            ...
            if(back)
            {
                ...
                {
                    BodyPart = "Back",
                    TargetBodyPart = "Upper Back, Latissimus Dorsi, and Teres Major",
                    Name = "Lat Pull Down",
                ...
                {
                    BodyPart = "Back",
                    TargetBodyPart = "Lower Back, Glutes, and Hamstrings",
                    Name = "Deadlift",
            ...
            routineListBox.ItemsSource = view;
        }
